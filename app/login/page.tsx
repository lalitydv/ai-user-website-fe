        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center space-y-4">
            <h1 className="text-4xl font-bold">
              <span className="text-[hsl(var(--brand-pink))]">WELCOME </span>
              <span className="text-[hsl(var(--brand-blue))]">BACK</span>
            </h1>
          ...
          <div className="text-right">
            <Link
              ...
              className="text-[hsl(var(--brand-blue))] hover:underline font-medium transition-all duration-300"
            >
              Forgot Password
            </Link>
          </div>
          ...
          <p className="text-center text-sm text-gray-600 dark:text-gray-300">
            ...
            <Link href="/signup" className="text-[hsl(var(--brand-pink))] hover:underline font-semibold">
              Sign up
            </Link>
          </p>
        </div>
